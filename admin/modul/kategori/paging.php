          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <b>
                  <p class="modal-title" id="hapus-kat<?= $pro['id'] ?>" style="text-align: center; font-size: 18px;">Apakah anda yakin ?</p>
                </b>
              </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <b>
                <p class="modal-title" id="edit-siswa<?= $pro['id'] ?>" style="text-align: center; font-size: 18px;">Edit Data Kategori</p>
              </b>
            </div>
            <div class="modal-body">
