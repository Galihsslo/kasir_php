          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <b>
                  <p class="modal-title" id="hapus-rak<?= $pro['id'] ?>" style="text-align: center; font-size: 18px;">Apakah anda yakin ingin dihapus?</p>
                </b>
              </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <b>
                <p class="modal-title" id="edit-rak<?= $pro['id'] ?>" style="text-align: center; font-size: 18px;">Edit Data Raak</p>
              </b>
            </div>
            <div class="modal-body">
